...
import com.dezhoutuu.mylibrary.FloatBall.floatball.FloatBall;
import com.dezhoutuu.mylibrary.FloatBall.floatball.FloatBallCfg;
import com.dezhoutuu.mylibrary.FloatBall.floatball.StatusBarView;
import com.dezhoutuu.mylibrary.FloatBall.menu.FloatMenu;
...
public class MyPopLayoutManager {
...
//    private StatusBarView statusBarView;
    ...
    public MyPopLayoutManager(Context application, FloatBallCfg ballCfg) {
        this(application, ballCfg, null);
    }

    public MyPopLayoutManager(Context application, FloatBallCfg ballCfg, FloatMenuCfg menuCfg) {
        mContext = application.getApplicationContext();
        mWindowManager = (WindowManager) mContext.getSystemService(Context.WINDOW_SERVICE);
        computeScreenSize();
        floatBall = new MyPopLayout(mContext, this, ballCfg);
...
//    }
     ...
     * @param item
     */
    public MyPopLayoutManager addMenuItem(MenuItem item) {
        menuItems.add(item);
        return this;
    }
     ...
     * @param items
     */
    public MyPopLayoutManager setMenu(List<MenuItem> items) {
        menuItems = items;
        return this;
    }

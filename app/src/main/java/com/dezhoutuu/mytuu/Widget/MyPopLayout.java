...
import com.dezhoutuu.mylibrary.FloatBall.FloatBallUtil;
import com.dezhoutuu.mylibrary.FloatBall.floatball.FloatBallCfg;
import com.dezhoutuu.mylibrary.FloatBall.runner.ICarrier;
import com.dezhoutuu.mylibrary.FloatBall.runner.OnceRunnable;
import com.dezhoutuu.mylibrary.FloatBall.runner.ScrollRunner;
import com.dezhoutuu.mylibrary.FloatBall.utils.MotionVelocityUtil;
import com.dezhoutuu.mylibrary.FloatBall.utils.Util;


public class MyPopLayout extends FrameLayout implements ICarrier {

    private MyPopLayoutManager floatBallManager;
//    private FloatBallManager floatBallManager;
    ...
    public MyPopLayout(Context context, MyPopLayoutManager floatBallManager, FloatBallCfg config) {
        super(context);
...
//        int statusBarHeight = floatBallManager.getStatusBarHeight();
        ...
        if ((gravity & Gravity.TOP) == Gravity.TOP) {
            ...
            y = floatBallManager.mScreenHeight / 2 - height / 2;
        }
